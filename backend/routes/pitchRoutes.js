...
router.post('/:id/accept', auth, role(['brand']), validateObjectId('id'), pitchController.acceptPitch);
router.post('/:id/reject', auth, role(['brand']), validateObjectId('id'), pitchController.rejectPitch);
